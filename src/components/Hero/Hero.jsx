...
const Hero = () => {
  return (
    <main className="mt-10 md:flex md:mt-24">
      <div className="flex w-screen md:w-2/4 justify-center">
      ...
      <div className="mt-10 md:mt-20 mx-5">
        ...
        <p className="mt-3 text-white text-justify md:w-[35rem] md:text-start">
        ...
        <button className="mt-5 px-5 py-3 rounded-md shadow-md text-white bg-red-500">
          About Me
        </button>
      </div>
    </main>
